pipeline {
    ...
    environment {
        ...
        DOCKER_REGISTRY_CREDENTIALS = credentials('docker-credentials') // Créez des identifiants Docker dans Jenkins et référencez-les ici
    ...
    stages {
        stage('Checkout') {
            steps {
                git 'https://github.com/ChetouiArij11/MediRendez/tree/main/backend'
            }
        }
